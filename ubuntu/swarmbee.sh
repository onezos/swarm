...
# 下载脚本
wget -O $cashScriptPath https://gist.githubusercontent.com/ralph-pichler/3b5ccd7a5c5cd0500e6428752b37e975/raw/cashout.sh && chmod a+x $cashScriptPath
else
...
wget https://github.com/ethersphere/bee-clef/releases/download/v0.4.12/bee-clef-linux-amd64 && dpkg -i bee-clef-linux-amd64
